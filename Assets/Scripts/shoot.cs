...
public class shoot : MonoBehaviour {
	...
	public GameObject rightProjectile;// The PREFAB we're using as a projectile
	...
	void Update () {
		...
		if (Input.GetMouseButtonDown (0)) { // "If the left mouse button was clicked this frame"
			...
			GameObject newProj = (GameObject)Instantiate (leftProjectile, transform.position, transform.localRotation);
			...
			GameObject newProj = (GameObject)Instantiate (rightProjectile, transform.position, transform.localRotation);
